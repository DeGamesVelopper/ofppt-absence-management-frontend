  ...
  const CloseModal = ()=>{
   ...
   const closeModalOnClick = e => { 
     const elemClicked = e.target.classList.value
      if (elemClicked) 
        if (elemClicked.includes("Modal__container") || elemClicked.includes("non") || elemClicked.includes("closeIcon") || elemClicked.includes("confirmModal__icon") || elemClicked.includes("txt")) {
          CloseModal()
        }
   }
  return (
