...
import { fetchFilieres,getFilieres ,editFiliere, deleteFiliere ,addFiliere ,getNextRows, getPrevRows, FilterFilieres } 
...
function Filiere() {
  ...
  const filter = () =>{
    dispatch(FilterFilieres({firstIndex,lastIndex,filtertext:searchInput}))
  }
